export const strings = {
  ...
  myAppointments: {
    ...
    emptyHint: "When you book a pathway, it will show up here.",
    cancel: "Cancel appointment",
    showSteps: "Show steps",
    hideSteps: "Hide steps",
    closeAria: "Close",
    countAria: (n: number) => `${n} upcoming appointment${n === 1 ? "" : "s"}`,
  },
  cancelDialog: {
    title: "Cancel this appointment?",
    warning:
      "This frees the slot for other patients and cannot be undone.",
    confirm: "Yes, cancel appointment",
    confirming: "Cancelling…",
    keep: "Keep appointment",
    success: (range: string) => `Cancelled ${range}`,
    alreadyGone: "That appointment is no longer on your list.",
  },
  confirmModal: {
